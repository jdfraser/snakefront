...
taunts = ['get_Booked!', 'brought_to_you_by_Checkfront!', 'generic_Taunt!', 'zort_narf_poit_Egad!',
          'you_are_not_Prepared!', 'ill_get_you_my_Pretty!', 'hiss_CamelNoise!', 'flee_Mortals!']
...
def get_move(data, head, heatmap, graph):
    ...
    elif ((longestSnakeLength + preferred_Snek_Length_modifer) >= len(
            data['oursnake']['coords']) and food_cost < dominace_Length):
        move = food_move
